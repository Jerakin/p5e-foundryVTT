...
# File copy of the gitdir project at https://github.com/sdushantha/gitdir
# Modified to work as a python module
# MIT LICENCE see https://github.com/sdushantha/gitdir/blob/master/LICENSE
...
def download(repo_url, flatten=False, output_dir="./"):
    ...
    if not flatten:
        if len(download_dirs.split(".")) == 0:
            ...
            dir_out = output_dir / "/".join(download_dirs.split("/")[:-1])
    else:
        dir_out = output_dir
    ...
    with open(response[0], "r") as f:
        ...
        for file in data:
            ...
            if flatten:
                path = output_dir / Path(file["path"]).name
            else:
